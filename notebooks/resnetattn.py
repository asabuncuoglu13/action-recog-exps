...
"""
Use self-attention 3d, you can either use
AttentionConv3d(3, 8, kernel_size=5, padding=2, groups=2) or
...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return AttentionConv3d(in_planes, out_planes, kernel_size=3, padding=2, groups=2)
